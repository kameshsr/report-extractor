...
public class QueryExecutor {
    ...
    private static final String DB_URL = "jdbc:postgresql://qa11.mosip.net:5433/mosip_regprc";
    private static final String DB_USER = "postgres";
    private static final String DB_PASS = "7x0*a!F1I6c!eSD$";
    // ------------------------------------------------------------------
...
//        String inputFile = "";
        String inputFile = "C:\\Users\\kames\\Downloads\\mosip\\automation_report\\DSL-api-internal.qa11-full-run-1769652130183-report_T-204_P-137_KI-27_I-12_S-0_F-28.html"; // Corrected path
        String outputFile = "output.txt";   // output file

        // Regex: capture value after /status/ ... until ) 
        String urlPattern = "End Point URL: http://packetcreator\\.packetcreator:80/v1/packetcreator/resident/status/([\\w\\-]+/api-internal\\.qa11_S\\d+_context)\\)";
